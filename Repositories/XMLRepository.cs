...
namespace TodoList.Repositories
{
    internal class XMLRepository
    {
        ...
        {
            XElement item = new XElement("item", new XElement("id", todo.Id), new XElement("title", todo.Title), new XElement("done", todo.IsDone));
        ...
        {
            return _doc.Root.Descendants("item").Count() ; 
        }
    }
